...
namespace Mirror
{
    ...
    public abstract class NetworkBehaviour : MonoBehaviour
    {
        ...
        public bool hasAuthority => netIdentity.isOwned;
        ...
        public bool authority
        {
            get
            {
                ...
                if (isClient && isServer) return syncDirection == SyncDirection.ServerToClient || hasAuthority;

                // client-only
                if (isClient) return syncDirection == SyncDirection.ClientToServer && hasAuthority;
        ...
        protected void InitSyncObject(SyncObject syncObject)
        {
            ...
            syncObject.IsWritable = () =>
            {
                ...
                if (NetworkServer.active && NetworkClient.active)
                    return syncDirection == SyncDirection.ServerToClient || hasAuthority;
                ...
                if (NetworkClient.active)
                {
                    ...
                    if (netId != 0) return syncDirection == SyncDirection.ClientToServer && hasAuthority;
